...
const SongItem = ({name,image,desc,id}) => {
  ...
  return (
    <div onClick={()=>playWithId(id)} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className={name === track.name?"relative text-green-400 bg-zinc-800 min-w-[180px] p-2 px-3 rounded cursor-pointer hover:bg-[#ffffff26]":'relative min-w-[180px] p-2 px-3 rounded cursor-pointer hover:bg-[#ffffff26]'}>
