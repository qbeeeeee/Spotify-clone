...
const SideBar = () => {
  return (
    <div className="bg-gradient-to-r from-green-800 to-green-900 min-h-screen pl-[4vw]">
        <img src={assets.logo} className="mr-5 mt-5 w-[max(10vw,100px)] hidden sm:block" alt="" />
